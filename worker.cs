...
namespace FreeMemory
{
    internal static class NativeMethods
    {
        ...
        public static bool CloseHandle(ref IntPtr Handle)
        {
            ...
            {
                result = ProcessPrivileges.NativeMethods.CloseHandle(Handle);
                if (!result)
                {
        ...
        public enum SYSTEM_INFORMATION_CLASS : ushort
        {
    ...
    /// <summary>All real work is done here, not in the static program</summary>
    public class Worker : IDisposable
    {
        #region Constants and enumerations
        private enum Commands : uint
        {
        ...
        } // EmptyCommands enumeration 
        #endregion // Constants and enumerations

        #region Variables
        private static readonly object StaticLock = new object();
        private SafeFileHandle TokenHandle = new SafeFileHandle(IntPtr.Zero, true);
        private ProcessPrivileges.AccessTokenHandle myProcessToken = null;

        #endregion // Variables

        #region LifeCycle
        /// <summary>Create instance and assign appropriate privileges</summary>
        public Worker()
        {
            InitPrivileges();
        }

        /// <summary>Release memory associated with object prior to garbage collection</summary>
        public void Dispose()
        {
            Dispose(true);
        }
        ...
        protected virtual void Dispose(bool IncludeManaged)
        {
            ...
            if (myProcessToken != null)
            {
                myProcessToken.Dispose();
            }
        ...
        /// <summary>Handy shortcut</summary>
#if NET45
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
#endif
        private static void FreeHeap(ref IntPtr ObjectPointer)
        { // This should be used for objects created with one of the Marshal methods like Marshal.AllocHGlobal or Marshal.StructureToPtr 
        ...
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
#endif
        private static void FreeStructure(ref IntPtr ObjectPointer, Type Structure)
        { // This should be used with structures returned by the kernel, not for managed objects
            if (ObjectPointer != IntPtr.Zero)
            {
                Marshal.DestroyStructure(ObjectPointer, Structure);
                ObjectPointer = IntPtr.Zero;
            }
        }
        ...
        /// <summary>Release Standby Memory Pages</summary>
        public void PurgeStandby()
        {
            InitPrivileges(); // should already be set ... but ... 

            var arr = new int[] { (int)Commands.MemoryPurgeStandbyList };
            var result = NativeMethods.NtSetSystemInformation(NativeMethods.SYSTEM_INFORMATION_CLASS.SystemMemoryListInformation, arr, (uint)(sizeof(int) * arr.Length));
            if (result != NativeMethods.NtStatus.Success)
            {
